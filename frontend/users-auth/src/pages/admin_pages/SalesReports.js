    ...
    return (
        <div id='salesReports'>
            <div className="pageHeader">
                ...
                <span className="pageDescription">The table below displays the list of products sold, sales income generated by each product, and the total amount of sales and products sold.</span>
            </div>
            <table>
                <thead>
                    <tr>
                        ...
                        <th>
                            <div className='sort'>
                                <div className='sortContainer'>
                                    <div>
                                                    <label>Type: </label>
                                                    <select className='sortSelect' value={filterType} onChange={handleFilterTypeChange}>
                                                ...
                                                {(filterType === 'annual' || filterType === 'monthly') && (
                                                    <div>
                                                        <label>Year: </label>
                                                        <input className='sortInput' type="number" value={selectedYear} onChange={handleYearChange} />
                                                    </div>
                                                )}
                                                ...
                                                {filterType === 'monthly' && (
                                                    <div>
                                                        <label>Month: </label>
                                                        <input className='sortInput' type="number" value={selectedMonth} onChange={handleMonthChange} min="1" max="12" />
                                                    </div>
                                                )}
                                                ...
                                                {filterType === 'weekly' && (
                                                    <div>
                                                        <label>Date: </label>
                                                        <input className='sortInput' type="date" value={selectedDate.toISOString().split('T')[0]} onChange={handleDateChange} />
                                                    </div>
                                                )}
                                </div>
                            </div>
